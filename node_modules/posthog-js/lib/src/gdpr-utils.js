...
export function userOptedOut(posthog, silenceErrors) {
    ...
    try {
        ...
        var respectDnt = posthog.config.respect_dnt;
        var persistenceType = posthog.config.opt_out_capturing_persistence_type;
        var persistencePrefix = posthog.config.opt_out_capturing_cookie_prefix || undefined;
        var win = posthog.config.window; // used to override window during browser tests
        if (token) {
