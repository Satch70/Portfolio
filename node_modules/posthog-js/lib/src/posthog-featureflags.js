...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype._reloadFeatureFlagsRequest = function () {
        ...
        this.instance._send_request(this.instance.config.api_host + '/decide/?v=3', { data: encoded_data }, { method: 'POST' }, this.instance._prepare_callback(function (response) {
    ...
    PostHogFeatureFlags.prototype.getEarlyAccessFeatures = function (callback, force_reload) {
        ...
        if (!existing_early_access_features || force_reload) {
            this.instance._send_request("".concat(this.instance.config.api_host, "/api/early_access_features/?token=").concat(this.instance.config.token), {}, { method: 'GET' }, function (response) {
                var _a;
                var _b;
